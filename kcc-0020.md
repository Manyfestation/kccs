...
Description: Defines the shared state, transfer interface, and borrowing rules for fungible-token covenants.
...
Implementations must enforce owner authorization, token-amount preservation,
transfer bounds, and complete successor authentication. Amount arithmetic must
reject overflow. Borrowed receive additionally requires preservation of
ownership and extended state, non-reduction of KAS value, and scheme-specific
authorization. Its outpoint-churn and authorization tradeoffs are discussed in
[KCC-20 Borrowed Receive Authorization](kcc-0020/borrowed-receive-authorization.md).
